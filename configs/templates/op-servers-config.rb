...
class OpServers < OpBase
  ...
  SERVERS = {
    ...
    dietbet_imageserver_dev:  {
      ...
      src:  '/var/www/dietbet_imageserver', 
    ...
    stepbet_prod:  {
      ...
      hostnames:  [:stepbet_prod_1, :stepbet_prod_2],
      src:  '/var/www/stepbet_prod', 
    ...
    dietbet_prod:  {
      ...
      hostnames:  [:dietbet_prod_1, :dietbet_prod_2, :dietbet_prod_3],
      src:  '/var/www/dietbet_prod', 
    ...
    stepbet_imageserver_prod:  {
      ...
      src:  '/var/www/stepbet_imageserver', 
      dst:  '/srv/stepbet/current',
    },
